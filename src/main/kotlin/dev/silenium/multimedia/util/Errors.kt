...
class EGLException(val operation: String, val error: Int) :
...
fun Int.asEGLError(operation: String = "EGL call"): Exception = EGLException(operation, this)
fun Int.asEGLErrorString(): String = eglErrorStringN(this)
...
private external fun eglErrorStringN(error: Int): String
