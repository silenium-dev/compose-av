...
JNIEXPORT jlong JNICALL Java_dev_silenium_multimedia_core_demux_FileDemuxerKt_positionN(
    JNIEnv *env,
    jobject thiz,
    const jlong context
) {
...
JNIEXPORT jlong JNICALL Java_dev_silenium_multimedia_core_demux_FileDemuxerKt_durationN(
    JNIEnv *env,
    jobject thiz,
    const jlong context
) {
...
JNIEXPORT jint JNICALL Java_dev_silenium_multimedia_core_demux_FileDemuxerKt_seekN(
    JNIEnv *env,
    jobject thiz,
    const jlong context,
...
JNIEXPORT jlong JNICALL Java_dev_silenium_multimedia_core_demux_FileDemuxerKt_nextPacketN(
    JNIEnv *env,
    jobject thiz,
    const jlong context
) {
...
JNIEXPORT jlong JNICALL Java_dev_silenium_multimedia_core_demux_FileDemuxerKt_initializeNativeContextN(
    JNIEnv *env,
    jobject thiz,
    const jstring url
) {
...
JNIEXPORT jlong JNICALL Java_dev_silenium_multimedia_core_demux_FileDemuxerKt_streamCountN(
    JNIEnv *env,
    jobject thiz,
    const jlong context
) {
...
JNIEXPORT jlong JNICALL Java_dev_silenium_multimedia_core_demux_FileDemuxerKt_streamN(
    JNIEnv *env,
    jobject thiz,
    const jlong context,
    const jlong index
...
JNIEXPORT jboolean JNICALL Java_dev_silenium_multimedia_core_demux_FileDemuxerKt_isSeekableN(
    JNIEnv *env,
    jobject thiz,
    const jlong context
) {
...
JNIEXPORT jlong JNICALL Java_dev_silenium_multimedia_core_demux_FileDemuxerKt_streamIndexN(
    JNIEnv *env,
    jobject thiz,
    const jlong packet
) {
