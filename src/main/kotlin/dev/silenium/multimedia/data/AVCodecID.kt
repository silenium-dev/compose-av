...
enum class AVCodecID : FFmpegEnum {
    ...
    val mediaType: AVMediaType by lazy { mediaTypeN(id).let(::fromId) }
...
private external fun toIdN(name: String): Int
private external fun mediaTypeN(value: Int): Int
private external fun descriptionN(value: Int): String
