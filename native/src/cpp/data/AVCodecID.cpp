...
static std::map<std::string, AVCodecID> codecNameMap{
    ...
    {"AV_CODEC_ID_PGX", AV_CODEC_ID_PGX},
    {"AV_CODEC_ID_AVS3", AV_CODEC_ID_AVS3},
    {"AV_CODEC_ID_MSP2", AV_CODEC_ID_MSP2},
    {"AV_CODEC_ID_VVC", AV_CODEC_ID_VVC},
    {"AV_CODEC_ID_H266",AV_CODEC_ID_H266},
    ...
    {"AV_CODEC_ID_XPM", AV_CODEC_ID_XPM},
    ...
    {"AV_CODEC_ID_IMM4", AV_CODEC_ID_IMM4},
    ...
    {"AV_CODEC_ID_AGM", AV_CODEC_ID_AGM},
    {"AV_CODEC_ID_LSCR", AV_CODEC_ID_LSCR},
    {"AV_CODEC_ID_VP4", AV_CODEC_ID_VP4},
    {"AV_CODEC_ID_IMM5", AV_CODEC_ID_IMM5},
    {"AV_CODEC_ID_MVDV", AV_CODEC_ID_MVDV},
    {"AV_CODEC_ID_MVHA", AV_CODEC_ID_MVHA},
    {"AV_CODEC_ID_CDTOONS", AV_CODEC_ID_CDTOONS},
    {"AV_CODEC_ID_MV30", AV_CODEC_ID_MV30},
    {"AV_CODEC_ID_NOTCHLC", AV_CODEC_ID_NOTCHLC},
    {"AV_CODEC_ID_PFM", AV_CODEC_ID_PFM},
    {"AV_CODEC_ID_MOBICLIP", AV_CODEC_ID_MOBICLIP},
    {"AV_CODEC_ID_PHOTOCD", AV_CODEC_ID_PHOTOCD},
    {"AV_CODEC_ID_IPU", AV_CODEC_ID_IPU},
    {"AV_CODEC_ID_ARGO", AV_CODEC_ID_ARGO},
    ...
    {"AV_CODEC_ID_RADIANCE_HDR", AV_CODEC_ID_RADIANCE_HDR},
    {"AV_CODEC_ID_WBMP", AV_CODEC_ID_WBMP},
    {"AV_CODEC_ID_MEDIA100", AV_CODEC_ID_MEDIA100},
    {"AV_CODEC_ID_VQC", AV_CODEC_ID_VQC},
    {"AV_CODEC_ID_PDV", AV_CODEC_ID_PDV},
    {"AV_CODEC_ID_EVC", AV_CODEC_ID_EVC},
    {"AV_CODEC_ID_RTV1", AV_CODEC_ID_RTV1},
    {"AV_CODEC_ID_VMIX", AV_CODEC_ID_VMIX},
    {"AV_CODEC_ID_LEAD", AV_CODEC_ID_LEAD},
    ...
    {"AV_CODEC_ID_PCM_S64LE", AV_CODEC_ID_PCM_S64LE},
    ...
    {"AV_CODEC_ID_PCM_SGA", AV_CODEC_ID_PCM_SGA},
    ...
    {"AV_CODEC_ID_ADPCM_IMA_SSI", AV_CODEC_ID_ADPCM_IMA_SSI},
    {"AV_CODEC_ID_ADPCM_ZORK", AV_CODEC_ID_ADPCM_ZORK},
    {"AV_CODEC_ID_ADPCM_IMA_APM", AV_CODEC_ID_ADPCM_IMA_APM},
    {"AV_CODEC_ID_ADPCM_IMA_ALP", AV_CODEC_ID_ADPCM_IMA_ALP},
    ...
    {"AV_CODEC_ID_ADPCM_XMD", AV_CODEC_ID_ADPCM_XMD},
    ...
    {"AV_CODEC_ID_WADY_DPCM", AV_CODEC_ID_WADY_DPCM},
    {"AV_CODEC_ID_CBD2_DPCM", AV_CODEC_ID_CBD2_DPCM},
    ...
    {"AV_CODEC_ID_INTERPLAY_ACM", AV_CODEC_ID_INTERPLAY_ACM},
    {"AV_CODEC_ID_XMA1", AV_CODEC_ID_XMA1},
    {"AV_CODEC_ID_XMA2", AV_CODEC_ID_XMA2},
    {"AV_CODEC_ID_DST", AV_CODEC_ID_DST},
    ...
    {"AV_CODEC_ID_ATRAC9", AV_CODEC_ID_ATRAC9},
    ...
    {"AV_CODEC_ID_FTR", AV_CODEC_ID_FTR},
    {"AV_CODEC_ID_WAVARC", AV_CODEC_ID_WAVARC},
    {"AV_CODEC_ID_RKA", AV_CODEC_ID_RKA},
    ...
    {"AV_CODEC_ID_TTML", AV_CODEC_ID_TTML},
    {"AV_CODEC_ID_ARIB_CAPTION", AV_CODEC_ID_ARIB_CAPTION},
    {"AV_CODEC_ID_FIRST_UNKNOWN", AV_CODEC_ID_FIRST_UNKNOWN},
    {"AV_CODEC_ID_TTF", AV_CODEC_ID_TTF},
    {"AV_CODEC_ID_SCTE_35", AV_CODEC_ID_SCTE_35},
    ...
    {"AV_CODEC_ID_WRAPPED_AVFRAME", AV_CODEC_ID_WRAPPED_AVFRAME},
    {"AV_CODEC_ID_VNULL", AV_CODEC_ID_VNULL},
...
JNIEXPORT jint JNICALL Java_dev_silenium_compose_av_data_AVCodecIDKt_toIdN(
    ...
    const auto nameBytes = env->GetStringUTFChars(name, nullptr);
    auto result = AV_CODEC_ID_NONE;
    if (codecNameMap.contains(nameBytes)) {
        result = codecNameMap[nameBytes];
    }
    env->ReleaseStringUTFChars(name, nameBytes);
    return result;
}
...
JNIEXPORT jstring JNICALL Java_dev_silenium_compose_av_data_AVCodecIDKt_descriptionN(
    ...
    return env->NewStringUTF(avcodec_get_name(static_cast<AVCodecID>(id)));
}
}
